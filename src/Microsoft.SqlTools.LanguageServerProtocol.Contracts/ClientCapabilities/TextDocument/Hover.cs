...
using Microsoft.SqlTools.LanguageServerProtocol.Contracts.Common;

namespace Microsoft.SqlTools.LanguageServerProtocol.Contracts.ClientCapabilities.TextDocument
{
    /// <summary>
